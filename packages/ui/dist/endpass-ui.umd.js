(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@endpass/utils/getOptionParameter')) :
  typeof define === 'function' && define.amd ? define(['exports', '@endpass/utils/getOptionParameter'], factory) :
  (global = global || self, factory(global['@endpass/ui'] = {}, global.getOptionParameter));
}(this, function (exports, getOptionParameter) { 'use strict';

  getOptionParameter = getOptionParameter && getOptionParameter.hasOwnProperty('default') ? getOptionParameter['default'] : getOptionParameter;
