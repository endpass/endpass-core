import { a as _createClass, b as _asyncToGenerator, c as _regeneratorRuntime, d as _classCallCheck, e as commonjsGlobal, f as createCommonjsModule } from './chunk-350af72f.js';
...
function () {
  ...
  _createClass(Transaction, null, [{
    ...
    key: "isToContract",
    value: function () {
      var _isToContract = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return web3$3.eth.getCode(transaction.to);

              case 2:
                res = _context.sent;
                return _context.abrupt("return", res !== '0x');
      ...
      function isToContract(_x) {
        return _isToContract.apply(this, arguments);
      }
    ...
    key: "getUpGasCost",
    value: function getUpGasCost(trx) {
      var token = trx.token;
      var gasCost = Transaction.getGasCost(trx);
      var tnxValue = token === 'ETH' ? Transaction.getValueInWei(trx) : DEFAULT_ZERO;
    ...
    key: "getGasFullPrice",
    value: function () {
      var _getGasFullPrice = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee2(transaction) {
        var estimatedGas, gasPriceWei;
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
              ...
              case 2:
                ...
                gasPriceWei = Transaction.getPriceWei(transaction);
                return _context2.abrupt("return", BigNumber(gasPriceWei).times(estimatedGas).toFixed());
      ...
      function getGasFullPrice(_x2) {
        return _getGasFullPrice.apply(this, arguments);
      }

      return getGasFullPrice;
    }()
  }, {
    key: "getApiObject",
...
var createTransactionClass = injectWeb3(Transaction);
    ...
    return _regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return import('./chunk-c85dad1d.js');
...
/*#__PURE__*/
function () {
  function ProxyRequest(connection) {
  ...
  _createClass(ProxyRequest, [{
    ...
    value: function setMode() {
      ...
      var url = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ENV.identityAPIUrl;
    ...
    _createClass(DebounceProvider, [{
      ...
      value: function createRequestHandler(cacheKey, method) {
        ...
        var send = function send() {
          get$1(getPrototypeOf(DebounceProvider.prototype), method, _this2).call(_this2, arguments.length <= 0 ? undefined : arguments[0], function (e, result) {
  ...
  function (_ParentProvider) {
    ...
    _createClass(SubscriptionProvider, [{
      ...
      value: function sendAsync(payload, callback) {
        ...
        return get$1(getPrototypeOf(SubscriptionProvider.prototype), "sendAsync", this).call(this, payload, callback);
      }
    }, {
  ...
  function (_ParentProvider) {
    ...
    _createClass(MockProvider, [{
      ...
      value: function send(payload) {
        ...
        return get$1(getPrototypeOf(MockProvider.prototype), "send", this).call(this, payload);
      }
    }, {
      key: "sendAsync",
      value: function sendAsync(payload, callback) {
